...
//*/
//public class FIR {
// public static byte RECTANGULAR = 0;// Rectangular window function
// public static byte BARTLETT = 1;// Bartlett (triangular) window
// public static byte HANNING = 2;// Hanning window
// public static byte HAMMING = 3;// Hamming window
// public static byte BLACKMAN = 4;// Blackman window
// public static byte BLACKMAN_HARRIS = 5;// Blackman-Harris window
// public static byte BLACKMAN_NUTTAL = 6;// Blackman-Nuttal window
// public static byte NUTTAL = 7;// Nuttal window
// //
// public static byte OFF = 0;
// public static byte LOWPASS = 1;
// public static byte HIGHPASS = 2;
// public static byte BANDSTOP = 3;// NOTCH
// public static byte BANDPASS = 4;
// //
// private static int GRIDDENSITY   = 16;
...
//                 System.Console.WriteLine("filter order must be lower than filter envelope length");
//                 return false;
//         }
//         if( (env.Length & (env.Length - 1)) != 0 ) {
//                 System.Console.WriteLine("filter envelope length must be power of 2");
//                 return false;
//         }
...
//         return (int)Math.Round( (float)((-10.0 * Math.Log10(deltaP * deltaS) - 13)/(14.6 * trband)) );      
// }
///*******************
//* createDenseGrid
//*=================
...
//                 System.Console.WriteLine("Reached maximum iteration count.");
//                 System.Console.WriteLine("Results may be bad.");
//         }
